...
public class commons {
	...
	public enum USER_LEVEL {
		SYSTEM_ADMIN("시스템관리자", 1), SITE_MANAGER("사이트관리자", 2), BOARD_MANAGER("게시판관리자", 3), LEVEL4("4등급", 4),
		LEVEL5("5등급", 5), ADVANCED_MEMBER("전문가", 6), EDITER_MEMBER("편집가", 7), NORMAL_MEMBER("일반회원", 8),
		TEMP_MEMBER("임시회원", 9), VISITER("방문자", 10);
